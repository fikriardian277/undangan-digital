document.addEventListener("DOMContentLoaded", () => {
  ...
  // =========================================================================
  const CONFIG = {
    pageTitle: "Sihab & Elvira Wedding",
    audio: "audio/badhif basalamah-bergema sampai selamanya.mp3",
    groom: {
      fullName: "Sihabudin Rizki Ramdani ",
      shortName: "Sihab",
      parents: "Putra Pertama dari Bapak Herman & Ibu Lilis",
      instagram:
        "https://www.instagram.com/sihabrizkiramdaniiiii?igsh=dmZ4cGJyMmZmZzM2",
      photo: "assets/mempelai-pria.JPG",
    },
    bride: {
      fullName: "Elvira Maulida",
      shortName: "Elvira",
      parents: "Putri Pertama dari Bapak Dadang & Ibu Erma",
      instagram: "https://www.instagram.com/elviramlida?igsh=dmZ4cGJyMmZmZzM2",
      photo: "assets/mempelai-wanita.JPG",
    },
    event: {
      isoDate: "2025-09-07T08:00:00",
      dateText: "MINGGU, 7 SEPTEMBER 2025",
      timeText: "<strong>PUKUL : 08.00 WIB - Selesai</strong>",
      locationText: `Tempat : Rumah mempelai wanita<br>Kp. Gunungbubut RT 018 RW 009 Desa Pakalongan Kecamatan Sodonghlir<br>Kabupaten Tasikmalaya`,
